...
\def\tytul{Aplikacja do testowania pamiêci krótkotrwa³ej
} % Proszê u¿yæ i ma³ych, i du¿ych liter!
...
\def\data{Zabrze, \today}%{Gliwice, MIESI¥C, ROK} % uwaga na wielkoœæ liter: grudzieñ 2012/czerwiec 2012/..
